            ...
            with allure.step("测试步骤3: 点击图片，进入游戏"):
                ...
                with allure.step(f"测试步骤3: 点击图片，进入游戏 - 游戏图片click 操作"):
                    ...
                    for attempt in range(1):
                        ...
                        try:
                            log_info(f"[test_SC] 执行第{attempt + 1}次图片操作: click on Game_Img/1759128096_Snipaste_2025-09-02_14-53-04.png")
                            time.sleep(3)
                            ...
                            if success:
                                ...
                                log_info(f"[{task_id}] test_SC 第{attempt + 1}次尝试：没有找到图片 Game_Img/1759128096_Snipaste_2025-09-02_14-53-04.png")
                                if attempt == 1 - 1:  # 最后一次尝试失败
